...
namespace archSmarter {
	...
	public static class mFunctions {
		...
		public static void writeCSVFile(string filePath, string fileContents) {
			...
			//write to file
			file = archSmarter.My.MyProject.Computer.FileSystem.OpenTextFileWriter(filePath, true);
		...
		public static List<archSmarter.mSheetMaker.structSheet> ReadCSV(string filePathName, bool hasHeaders) {
			List<archSmarter.mSheetMaker.structSheet> sheetList = new List<archSmarter.mSheetMaker.structSheet>();
			...
			using(Microsoft.VisualBasic.FileIO.TextFieldParser MyReader = new Microsoft.VisualBasic.FileIO.TextFieldParser(filePathName)) {
				...
				while(!MyReader.EndOfData) {
					try {
						...
						archSmarter.mSheetMaker.structSheet curSheet = new archSmarter.mSheetMaker.structSheet();
